...
public class MainActivity extends Activity {
	...
	private TextView statusView, stepsView, classifierView, speechStatusView;
	private CompoundButton accelButton, microphoneButton;
	...
	class IncomingHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case Context_Service.MSG_ACTIVITY_STATUS:
            {
                ...
                classifierView.setText(activity);
            	break;
            }
            ...
            case Context_Service.MSG_MICROPHONE_STARTED:
            {
                if(microphoneButton!=null) {
                    microphoneButton.setChecked(true);
            ...
            {
                if(microphoneButton!=null) {
                    microphoneButton.setChecked(false);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        classifierView = (TextView) findViewById(R.id.ClassifierView);
        ...
        microphoneButton = (ToggleButton) findViewById(R.id.MicrophoneButton);
        microphoneButton.setChecked(microphoneStarted);
        microphoneButton.setOnCheckedChangeListener(
                new OnCheckedChangeListener() {
                    public void onCheckedChanged(CompoundButton btn,boolean isChecked) {
                        microphoneStarted = Context_Service.isMicrophoneRunning();
